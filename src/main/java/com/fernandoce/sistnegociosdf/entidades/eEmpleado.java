 ...
 * @author lfern
 */
public class eEmpleado extends ePersona{
    ...
    public eEmpleado(String cargo, String username, String contrasenia, String ultimo_Acceso, String primerAcceso, int idPersona, String nombre, String apPaterno, String apMaterno, int tipoDoc, String numDoc, String telefono, String dirección, String fechaCreacion, String estado, int idTipoDoc, String abrevTipoDoc) {
